...
@section('content')
    <main class="flex-1 p-4 lg:p-6 overflow-auto bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div class="overflow-x-auto border border-gray-200 rounded-xl bg-white shadow-sm">
            ...
            <div class="p-6">
                <div
                    class="border border-gray-200 rounded-xl bg-gradient-to-br from-white to-gray-50 p-6 hover:shadow-lg transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h1 class="text-lg font-semibold text-black mb-1">Riverside Clinic</h1>
