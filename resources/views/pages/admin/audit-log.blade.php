                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-900">2024-10-14 14:30:25</span>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <span
                                    class="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium flex items-center gap-1.5 w-fit">
                            ...
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600 font-mono">192.168.1.100</span>
                            </td>
                            <td class="px-6 py-4">
                                <span
                            ...
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600">Successful login</span>
                            </td>
                        </tr>

                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-900">2024-10-14 14:25:10</span>
                            </td>
                            <td class="px-6 py-4">
                                <span class="text-sm font-medium text-gray-900">Admin User</span>
                            </td>
                            <td class="px-6 py-4">
                                <span
                                    class="px-3 py-1 bg-orange-100 text-orange-700 rounded-full text-xs font-medium flex items-center gap-1.5 w-fit">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-3.5 h-3.5">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                            ...
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600">User: Sarah Johnson</span>
                            </td>
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600 font-mono">192.168.1.100</span>
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600">Updated user role to Senior Nurse</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
