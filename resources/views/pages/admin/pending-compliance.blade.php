                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span class="text-sm font-medium text-gray-900">Robert Taylor</span>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-700">RN License</td>
                            <td class="px-6 py-4 text-sm text-gray-600">2024-10-12</td>
                            <td class="px-6 py-4">
                                <span
                        ...
                        <!-- Row 2 -->
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 text-sm font-medium text-gray-900">P002</td>
                            <td class="px-6 py-4">
                                <span class="text-sm font-medium text-gray-900">Jennifer White</span>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-700">CPR Certification</td>
                            <td class="px-6 py-4 text-sm text-gray-600">2024-10-13</td>
                            <td class="px-6 py-4">
                                <span
                                    class="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium inline-flex items-center gap-1.5">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        <!-- Row 3 -->
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 text-sm font-medium text-gray-900">P003</td>
                            <td class="px-6 py-4">
                                <span class="text-sm font-medium text-gray-900">William Brown</span>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-700">Liability Insurance</td>
                            <td class="px-6 py-4 text-sm text-gray-600">2024-10-14</td>
                            <td class="px-6 py-4">
                                <span
                                    class="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium inline-flex items-center gap-1.5">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
