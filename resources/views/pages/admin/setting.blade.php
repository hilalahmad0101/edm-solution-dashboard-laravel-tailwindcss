    ...
    <main class="flex-1 p-4 lg:p-6 overflow-auto bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div class="mb-6">
            <div class="flex items-center gap-2 border-b border-gray-200">
                <button class="px-4 py-3 text-sm font-semibold text-white bg-black rounded-t-lg">
                    Profile & Account
                </button>
                <button
            ...
            <div class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center gap-4">
                        <div
                            class="w-20 h-20 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white text-2xl font-bold">
                            AU
                        </div>
                        <button
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" value="admin@primitivelove.com"
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="tel" value="+1-555-0100"
                            class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent transition-all">
                    </div>
                </div>
