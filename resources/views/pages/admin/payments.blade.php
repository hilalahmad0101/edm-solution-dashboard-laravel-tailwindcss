  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
        ...
        <div class="py-6 flex items-center space-x-3">
            <div class="bg-[#ECECF0] p-1.5  w-[500px] rounded-full space-x-5 flex items-center justify-between">
                <a href="/payments" class=" bg-white py-2 px-5 text-[14px] rounded-full  font-normal text-[#0A0A0A]">
                    Facility Payments
                </a>
                <a href="/payout-payments" class="  py-2 px-5 text-[14px] rounded-full  font-normal text-[#0A0A0A]">
                    User Payouts
                </a>
        ...
        <div class="overflow-x-auto mt-6 border border-[#0000001A] rounded-lg bg-white p-6">
            <div class="mb-6">
                <h2 class="text-[16px] font-normal text-gray-800">Facility Payment Invoices ( 6 )</h2>
            </div>
