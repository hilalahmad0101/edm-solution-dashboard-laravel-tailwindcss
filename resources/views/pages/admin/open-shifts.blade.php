    ...
    <main class="flex-1 p-4 lg:p-6 overflow-auto bg-gradient-to-br from-gray-50 to-gray-100" x-data="{
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                ...
                <div class="text-3xl font-bold text-gray-900 mb-1">$40/hr</div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex items-start justify-between mb-4">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-1">Registered Nurse (RN)</h3>
                ...
                <div class="mb-4">
                    ...
                    <p class="text-sm text-gray-700">RN License, BLS</p>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex items-start justify-between mb-4">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-1">Licensed Practical Nurse (LPN)</h3>
                        <div class="flex items-center gap-1.5 text-sm text-gray-600">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-gray-400">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="mb-4">
                    <div class="text-xs font-medium text-gray-600 mb-2">Department:</div>
                    <span
                        class="inline-block px-3 py-1 bg-blue-50 text-[#1F3C88]/90 rounded-full text-xs font-medium">General
                        Ward</span>
                </div>

                <div class="mb-4">
                    <div class="text-xs font-medium text-gray-600 mb-2">Requirements:</div>
                    <p class="text-sm text-gray-700">LPN License, CPR</p>
                </div>
