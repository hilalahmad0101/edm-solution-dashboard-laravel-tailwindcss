    ...
    <main class="flex-1 p-4 lg:p-6 overflow-auto bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div class="bg-gray-100 p-1.5 rounded-lg flex items-center gap-1 shadow-sm mb-6 w-fit">
            <button onclick="window.location.href='/compliance'"
                class="py-2 px-4 text-sm rounded-md font-medium text-gray-600 hover:text-black hover:bg-white/50 transition-all">
                All Credentials
            </button>
            ...
            <button onclick="window.location.href='/expired'"
                class="bg-white py-2 px-4 text-sm rounded-md font-medium text-black shadow-sm transition-all">
                Expired
            </button>
        </div>
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    <span class="text-sm font-semibold text-red-600">4</span>
                                    <span class="text-xs text-red-500">days</span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <span
